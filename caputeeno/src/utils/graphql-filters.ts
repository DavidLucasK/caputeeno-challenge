...
export function getFieldByPriority(priority: PriorityTypes) {
    ...
    if(priority === PriorityTypes.MAJOR_PRICE) return {field: "price-in-cents", order: "ASC"}
    if(priority === PriorityTypes.MINOR_PRICE) return {field: "price-in-cents", order: "ASC"}
